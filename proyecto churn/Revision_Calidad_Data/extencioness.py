...
# %%
##%run pandas_missing-extension.ipynb
import itertools
import pandas as pd
import upsetplot
import numpy as np
...
# %% [markdown]
# <a style='text-decoration:none;line-height:16px;display:flex;color:#5B5B62;padding:10px;justify-content:end;' href='https://deepnote.com?utm_source=created-in-deepnote-cell&projectId=8f53f3e0-1c3f-4c93-a27a-34dc9a39d8ce' target="_blank">
